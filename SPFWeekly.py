...
channel_list = ['Facebook', 'Owned channel', 'Tiktok', 'News', 'Forum', 'Threads', 'Instagram', 'Youtube', 'E-commerce']
...
file_dir1 = r"C:\Users\Kompa-KTelt056\Desktop\spf2002.xlsx"
file_dir2 = r"C:\Users\Kompa-KTelt056\Desktop\be2002.xlsx"
file_dir3 = r"C:\Users\Kompa-KTelt056\Desktop\grab2002.xlsx"
#file_dir2 = r"C:\Users\Kompa-KTelt056\Desktop\go2329.xlsx"
# file_name = r'C:\Users\Admin\Desktop\bae2904.xlsx'


df1 = vx.from_pandas(pd.read_excel(file_dir1, sheet_name='Data'))
df2 = vx.from_pandas(pd.read_excel(file_dir2, sheet_name='Data'))
df3 = vx.from_pandas(pd.read_excel(file_dir3, sheet_name='Data'))
#df2 = vx.from_pandas(pd.read_excel(file_dir2, sheet_name='Data'))
# df5 = vx.from_pandas(pd.read_excel(file_name, sheet_name='Data'))

df = vx.concat([df1, df2, df3])
...
Slide_6_list.append(channel_pct_df)
...
for each_channel in ['News', 'Owned channel', 'Facebook']:
    ...
    Slide_6_list.append(brand_by_channel_df)
    ...
    if each_channel in ['Facebook', 'Owned channel']:
        ...
        Slide_6_list.append(voice_df)
slide_n_df_dict['Slide 6'] = Slide_6_list
...
slide_n_df_dict['Slide 7'] = overall_sent_df


# ============================== TREND-LINE (Slide9):
slide_n_df_dict['Slide 9'] = datemerge(df_exclude_minigame.groupby(['PublishedDate', 'Topic']).agg({'Id': 'count'}).to_pandas_df().pivot_table(
    index='PublishedDate', values='Id', aggfunc='sum', columns='Topic').reindex(topic_list, axis=1), '2025-01-20', '2025-02-02')
...
Slide_13_list = []
for brand in ['ShopeeFood', 'GrabFood', 'BeFood']:
...
for voice in ['User', 'Merchant', 'Shipper']:
    for sent in ['Positive', 'Negative']:
        # print(df_exclude_minigame[df_exclude_minigame['Sentiment'] == sent]['Id', 'Voice'].to_pandas_df())
        exclude_minigame_voice_sent_df = df_exclude_minigame[(df_exclude_minigame['Voice'] == voice) & (df_exclude_minigame['Sentiment'] == sent)]
        # print(exclude_minigame_voice_sent_df.groupby(['Title', 'Channel', 'UrlTopic']).agg({'Id': 'count'}))
...
to_excel_file('SPF2002OutPut', slide_n_df_dict)